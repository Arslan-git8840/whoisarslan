    ...
    <div className="bg-black selection:bg-pink-700">
      ...
      <BackgroundLines className="flex pt-2 w-full flex-col px-4 space-y-6">
        ...
        <div className="flex flex-col flex-1 lg:flex-row justify-between gap-8 lg:gap-0">
          {/* Text Section */}
          <div className="w-full lg:w-1/2 px-16 lg:pt-32 pt-8 flex flex-col items-start md:space-y-10 space-y-4">
          ...
          <div className="w-full lg:flex-1 flex justify-center">
            {/* <GlobeGlobe /> */}
            <img src="/mainIconsdark.svg" alt="mainIconsdark" className="h-[85%] md:block hidden" />
          </div>
      ...
      <div className="relative py-6">
        ...
        <div className="w-full h-auto flex flex-col items-center justify-center md:mt-0 mt-7">
      ...
      <div className="bg-black md:py-4 pb-6 md:pb-0 py-0 px-4 md:px-8">
        <Contact />
      </div>
